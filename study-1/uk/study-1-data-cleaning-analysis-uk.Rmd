...
# Random slopes (response level) with uncorrelated intercepts 
modelsTaskList$randomFifthCombined  <-
  lmer(nudgeResponse ~ (0 + nudge|participantID),
	data = dataStudy1UKTaskCleanIncluded)

# AIC and BIC do not agree here
# Combined model should be run with both random structures and if the four-way interaction is significant in both models, we are fit separate models for each nudge
